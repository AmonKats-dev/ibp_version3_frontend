...
dhtmlxPivot v.1.5.3 Professional
...
var drivers_1 = __webpack_require__(29);
...
Object.defineProperty(exports, "__esModule", { value: true });
var html_1 = __webpack_require__(2);
var focus_1 = __webpack_require__(79);
...
var editors_1 = __webpack_require__(82);
var html_1 = __webpack_require__(2);
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(1);
var DateFormatter_1 = __webpack_require__(115);
...
function getUniqueFieldData(field, data) {
    if (field.type === "date") {
        return core_1.naturalSort(data.map(function (item) { return item[field.id].getTime(); }).filter(function (el, i, arr) { return arr.indexOf(el) === i; }));
    }
    return core_1.naturalSort(data.map(function (item) { return item[field.id]; }).filter(function (el, i, arr) { return arr.indexOf(el) === i; }));
}
...
(function (PivotEvents) {
    ...
    PivotEvents["filterCancel"] = "filterCancel";
...
var loader_1 = __webpack_require__(63);
var sort_1 = __webpack_require__(66);
var dataproxy_1 = __webpack_require__(11);
var helpers_1 = __webpack_require__(8);
var types_1 = __webpack_require__(7);
var core_1 = __webpack_require__(1);
...
Object.defineProperty(exports, "__esModule", { value: true });
var JsonDriver_1 = __webpack_require__(30);
var CsvDriver_1 = __webpack_require__(31);
var XMLDriver_1 = __webpack_require__(64);
exports.dataDrivers = {
...
var Exporter_1 = __webpack_require__(76);
var data_1 = __webpack_require__(19);
var main_1 = __webpack_require__(9);
var Selection_1 = __webpack_require__(77);
var KeyManager_1 = __webpack_require__(78);
var types_1 = __webpack_require__(3);
var render_1 = __webpack_require__(81);
var core_1 = __webpack_require__(1);
...
var types_1 = __webpack_require__(95);
...
var TreeGridCollection = /** @class */ (function (_super) {
    ...
    TreeGridCollection.prototype.serialize = function (driver) {
        ...
        this.eachChild(this.getRoot(), function (el) {
            ...
            var cell = __assign(__assign({}, el), { $level: el.$level || _this.getLevel(el.id), $items: _this.haveItems(el.id) });
    ...
    TreeGridCollection.prototype._parse_data = function (data, parent) {
        ...
        for (var _i = 0, data_1 = data; _i < data_1.length; _i++) {
            ...
            obj.$level = obj.$level || this.getLevel(obj.id);
...
var dom_1 = __webpack_require__(0);
var html_1 = __webpack_require__(2);
var Filters_1 = __webpack_require__(48);
var en_1 = __webpack_require__(10);
...
var Configurator = /** @class */ (function () {
    ...
    Configurator.prototype.getShadow = function () {
        ...
        return dom_1.el("div", {
            ...
            dom_1.el(".item_body", [
                this.config.layout.showFilters !== false &&
                    dom_1.el(".dhx_item_filter", {
    ...
    Configurator.prototype._getItem = function (item) {
        ...
        return dom_1.el(".dhx_config_item", {
            ...
            dom_1.el(".item_body", {
                _ref: item.$uid,
                class: !this._pivot.grid.data.getLength() ? "item_body--disabled" : "",
            }, [
                this.config.layout.fieldsCloseBtn === true &&
                    item.$field !== "free" &&
                    dom_1.el(".dhx_close", { class: "dxi dxi-close" }),
                this.config.layout.showFilters !== false &&
                    dom_1.el(".dhx_item_filter", {
                        class: "dxi dxi-filter-variant " + (filters[item.id] ? "dhx_item_filter--flat" : ""),
                    }),
    ...
    Configurator.prototype._deleteItem = function (id) {
        ...
        config.fields[item.$field] = config.fields[item.$field].filter(function (f) { return f.$uid !== item.$uid; });
    };
    ...
    Configurator.prototype._getLoopSelect = function (item) {
        ...
        var val = item[type.name]
            ? exports.types[type.id].filter(function (t) { return t.id === item[type.name]; })[0]
            : exports.types[type.id][0];
        if (!val) {
            return null;
        }
    ...
    Configurator.prototype._getDropdownSelect = function (item) {
        ...
        return dom_1.el(".dhx_item-modes", [
            dom_1.el("select.dhx_item-modes__select", {
                ...
                var localeLabel = en_1.default.types[type.id] && en_1.default.types[type.id].find(function (l) { return l.id === method.id; })
                    ? en_1.default.types[type.id].find(function (l) { return l.id === method.id; }).label
                    : method.label;
                return dom_1.el("option.dhx_select__option", {
                    value: method.id,
                    selected: item[type.name] === method.id,
                }, localeLabel);
            })),
...
Object.defineProperty(exports, "__esModule", { value: true });
var DateFilter_1 = __webpack_require__(114);
...
function getFilterHandler(meta, field) {
    return function (item) {
        ...
        return meta.values.includes(item);
    };
}
...
var Filters = /** @class */ (function () {
    ...
    Filters.prototype.getFilter = function (item, coords, data, oldMeta) {
        ...
        if (this._filter && this._filter.isVisible() && this._filter.getItem() !== item) {
            this._filter.hide();
            this._filter = null;
        }
        if (!this._filter) {
            ...
            this._filter.config.events.on("filterCancel", function () {
                _this._filter = null;
            });
        }
    };
...
exports.operations = {
    string: {
        ct: {
            name: function () { return en_1.default.contains; },
            handler: function (item, str) { return new RegExp("^" + str, "i").test(item); },
        },
        nct: {
            name: function () { return en_1.default.notContains; },
            handler: function (item, str) { return !new RegExp("^" + str, "i").test(item); },
        },
...
var Filter = /** @class */ (function (_super) {
            ...
            onclick: html_1.eventHandler(function (ev) { return html_1.locate(ev); }, {
                dhx_filter_selectAll: function (_ev) {
                    if (_this._meta.values.length) {
                        ...
                        _this._meta.values = __spreadArrays(_this._data);
                    }
                    _this.paint();
                },
                dhx_button: function (_ev, item) {
                    if (item === "hide") {
                        _this.config.events.fire("filterCancel", [_this._item.id, _this.getMeta()]);
                        _this.hide();
                    }
                    if (item === "apply") {
    ...
    Filter.prototype.show = function (node) {
        this._popup.show(node, { mode: "bottom", centering: true });
    };
    ...
    Filter.prototype._getContent = function () {
        return dom_1.el(".dhx_filter", {
            ...
            dom_1.el(".dhx_filter-buttons", [
                dom_1.el("button", {
                    class: "dhx_button dhx_button--view_link dhx_button--color_primary dhx_button--size_medium",
                    dhx_id: "hide",
                    type: "button",
                }, en_1.default.cancel),
                dom_1.el("button", {
                    class: "dhx_button dhx_button--view_flat dhx_button--color_primary dhx_button--size_medium",
                    dhx_id: "apply",
                    type: "button",
                }, en_1.default.apply),
            ]),
        ...
        return dom_1.el(".dhx_filter_field", [
            ...
            dom_1.el(".dhx_field_input", [
                dom_1.el("input.dhx_input", {
                    class: "dhx_field_input",
                    value: this._meta.filter || "",
                    placeholder: en_1.default.typeHere,
                    type: "text",
                    _key: "inp",
                }, this._meta.filter || ""),
            ]),
    ...
    Filter.prototype._getCheckboxes = function () {
        ...
        var checkboxes = dom_1.el(".dhx_list", data.map(function (label, i) {
            var isChecked = _this._meta.values.includes(label);
...
Object.defineProperty(exports, "__esModule", { value: true });
var groupfuncs_1 = __webpack_require__(51);
var core_1 = __webpack_require__(1);
var en_1 = __webpack_require__(10);
// [dirty]
var pivotConfig;
...
function setRowsLabels(rows, uniqueRows, level, rowName, parent) {
    ...
    if (pivotConfig.layout.gridMode === "tree") {
        ...
        rows.forEach(function (_row, i) {
            ...
            firstColumns[i] = text;
            firstColumns.$level = level ? level - 1 : level - 0.8;
        });
    }
...
function getGroupedData(config, columns, _data) {
    ...
    if (fields) {
        var _loop_1 = function (i) {
            ...
            uniqueRows[i] = __assign(__assign({}, row), uniqueRows[i]);
        };
...
function getHeader(config, columns) {
    ...
    var width = config.layout.columnsWidth ? config.layout.columnsWidth : null;
    if (pivotConfig.layout.gridMode === "tree") {
        var header = [];
        for (var i = 0; i <= config.fields.columns.length; i++) {
            header.push({ text: "" });
        }
        result = [
            {
    ...
    for (var i = 0; i < columns.length; i++) {
        var _loop_3 = function (field) {
            ...
            for (var level = 0; level < columns[i].length; level++) {
                ...
                colspans[level] = colspans[level] || 1;
                ...
                if (prevKeys[level] !== key) {
                    ...
                    column.push(__assign(__assign({}, spanCells[level]), { align: "right" }));
                }
                else {
            ...
            column.push({
                text: (field.label || field.id) + " (" + en_1.default[field.method] + ")",
                align: "right",
            });
            var col = {
                header: column,
            ...
            if (config.layout && config.layout.footer) {
...
function normalizeFooter(grid, cols) {
    var content = grid.content;
    var datacollection = grid.data;
    var data = datacollection.serialize();
    var _loop_4 = function (col) {
        var id = col.id;
        var columnData = data.reduce(function (items, item) {
            if (item[id] !== undefined && item[id] !== "" && !isNaN(item[id])) {
                items.push(parseFloat(item[id]));
            }
            return items;
        }, []);
        var roots = data.reduce(function (total, item) {
            if (item.$level === 0) {
                if (item[id] !== undefined && item[id] !== "" && !isNaN(item[id])) {
                    ...
                    var value_1 = 0;
                    datacollection.eachChild(item.id, function (cell) {
                        if (!datacollection.haveItems(cell.id)) {
        ...
        if (content[col.method] && col.template) {
            var val = content[col.method].calculate(columnData, roots);
            var htmlVal = col.template(val);
            col.footer = [{ text: htmlVal, aligh: col.align }];
        }
    };
...
function getGridData(config, data, grid) {
    pivotConfig = config;
    ...
    if (config.layout && config.layout.footer && config.customFormat) {
        grid.data.parse(groupedData);
        normalizeFooter(grid, headers);
    }
    return {
        headers: headers,
...
Object.defineProperty(exports, "__esModule", { value: true });
var DataGroup_1 = __webpack_require__(50);
...
exports.mathMethods = {
    sum: function (data) {
        return data.reduce(function (prev, el) { return prev + el; });
    },
    min: function (data) {
        return data[0];
    },
...
function methods(data, field, method) {
    ...
    data = data
        .map(function (obj) { return parseFloat(obj[field]) || 0; })
...
// HELPERS
var CssManager_1 = __webpack_require__(16);
...
// WIDGETS
var Pivot_1 = __webpack_require__(72);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(17), __webpack_require__(61)))
...
Object.defineProperty(exports, "__esModule", { value: true });
var xml_1 = __webpack_require__(65);
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(1);
var datacollection_1 = __webpack_require__(28);
var dataproxy_1 = __webpack_require__(11);
var helpers_1 = __webpack_require__(8);
var types_1 = __webpack_require__(7);
...
Object.defineProperty(exports, "__esModule", { value: true });
var html_1 = __webpack_require__(2);
var CollectionStore_1 = __webpack_require__(69);
var types_1 = __webpack_require__(7);
var helpers_1 = __webpack_require__(8);
...
var view_1 = __webpack_require__(6);
var ts_data_1 = __webpack_require__(5);
var ts_treegrid_1 = __webpack_require__(73);
var ts_layout_1 = __webpack_require__(23);
var Configurator_1 = __webpack_require__(47);
var Fields_1 = __webpack_require__(116);
var DataPreprocessor_1 = __webpack_require__(117);
var DataGroup_1 = __webpack_require__(50);
var groupfuncs_1 = __webpack_require__(51);
var CssManager_1 = __webpack_require__(16);
var en_1 = __webpack_require__(10);
var types_1 = __webpack_require__(27);
var Exporter_1 = __webpack_require__(118);
var Shadow_1 = __webpack_require__(119);
var Pivot = /** @class */ (function (_super) {
    ...
    function Pivot(container, config) {
        ...
        _this.cssManager = CssManager_1.cssManager;
        ...
        _this._initLayout();
        _this._checkLayoutState();
        var gridRoot = _this.grid.getRootView();
        gridRoot.hooks = gridRoot.hooks || {};
        gridRoot.hooks.didMount = function () {
            _this.container = _this.layout.getRootView().node.el;
        };
        _this.export = Exporter_1.getExporter(_this);
        _this._shadow = new Shadow_1.Shadow(_this._configurator);
        var view = dom_1.create({ render: function () { return _this._render(); } });
        _this.mount(container, view);
        return _this;
    }
    Pivot.prototype.destructor = function () {
        this._shadow.destructor();
    ...
    Pivot.prototype.addMathMethod = function (id, label, func) {
        ...
        this.grid.content[id] = {
            ...
            calculate: function (column, config) {
                var columnData = config.data.map(function (item) {
                    return item.$items && item.$opened ? "0" : item[column.id] || "0";
                });
    ...
    Pivot.prototype._update = function () {
        ...
        var gridInfo = DataGroup_1.getGridData(__assign(__assign({}, this.config), { fields: fields }), this._dataPrep.getData(this.config.data || [], fields), this.grid);
        this.grid.setColumns(gridInfo.headers);
        this.grid.data.parse(gridInfo.groupedData);
        if (this.config.layout.columnsWidth === "auto") {
            this.grid.config.columns.forEach(function (col) {
                _this.grid.adjustColumnWidth(col.id);
            });
        }
        else if (!this.config.layout.columnsWidth) {
            this.grid.adjustColumnWidth(this.grid.config.columns[0].id);
            if (this.config.layout.gridMode === "flat") {
                this.grid.adjustColumnWidth(this.grid.config.columns[1].id);
            }
        }
    };
    Pivot.prototype._init = function () {
        ...
        this._configurator = new Configurator_1.Configurator(this, __assign(__assign({}, this.config), { events: this.events }));
    };
    Pivot.prototype._initLayout = function () {
        var _this = this;
        var columnsStyle = this.cssManager.add({
            paddingLeft: (this.config.layout.leftMargin || 168) + 12 + "px",
        });
        var rowsStyle = this.cssManager.add({
            minWidth: (this.config.layout.leftMargin || 168) + "px",
        });
        var pivotHeader = [
            { id: "freeFields", css: "dhx_free-fields-wrap dhx_config_free-items" },
            { id: "hideSettings", css: "dhx_settings-button-wrap", width: "content" },
        ];
        if (!this.config.layout.liveReload) {
            pivotHeader.splice(1, 0, { id: "manualApply", css: "dhx_apply-button-wrap" });
        }
        var layout = (this.layout = new ts_layout_1.Layout(null, {
            views: [
                {
                    css: "dhx_config",
                    id: "full",
                    rows: [
                        {
                            id: "pivotHeader",
                            css: "dhx_pivot-header",
                            cols: pivotHeader,
                            height: "content",
                        },
                        {
                            id: "mainArea",
                            css: "dhx_pivot-main-area",
                            rows: [
                                {
                                    id: "valuesFields",
                                    css: "dhx_values-fields-wrap",
                                    height: "content",
                                },
                                {
                                    id: "columnsFields",
                                    css: "dhx_columns-fields-wrap " + columnsStyle,
                                    height: "content",
                                },
                                {
                                    id: "gridWrapper",
                                    css: "dhx_pivot-grid-wrap",
                                    cols: [
                                        {
                                            id: "rowsFields",
                                            css: "dhx_rows-fields-wrap " + rowsStyle,
                                            width: "content",
                                        },
                                        {
                                            id: "grid",
                    ...
                    rows: [
                        {
                            ...
                            rows: [
                                {
                                    id: "showSettings",
                                    css: "dhx_settings-button-wrap dhx_settings-button-wrap--readonly",
                                    height: "content",
                                },
                                {
                                    id: "gridOnlyWrap",
        ...
        layout.getCell("grid").attach(this.grid, this);
        layout.getCell("freeFields").attach(free, this);
        layout.getCell("valuesFields").attach(values, this);
        layout.getCell("columnsFields").attach(cols, this);
        layout.getCell("rowsFields").attach(rows, this);
        layout.getCell("gridOnlyWrap").attach(this.grid, this);
        var getSettingsButton = function (type) { return ({
            getRootView: function () {
                return dom_1.el("button", __assign(__assign({ class: "pivot_settings_btn dhx_button dhx_button--view_link dhx_button--color_primary dhx_button--size_medium" }, _this._htmlEvents), { type: "button" }), en_1.default[type === "hide" ? "hideSettings" : "showSettings"]);
            },
        }); };
        var getManualApplyButton = function (type) { return ({
            getRootView: function () {
                return dom_1.el("button", __assign(__assign({ class: "dhx_pivot-apply-button dhx_button dhx_button--view_flat dhx_button--color_primary dhx_button--size_medium", dhx_id: "dhx_configApplyBtn" }, _this._htmlEvents), { type: "button" }), [dom_1.el("i.dxi.dxi-check"), dom_1.el("span", en_1.default.apply)]);
            },
        }); };
        layout.getCell("showSettings").attach(getSettingsButton("show"), this);
        layout.getCell("hideSettings").attach(getSettingsButton("hide"), this);
        if (this.config.layout.liveReload === false) {
            layout.getCell("manualApply").attach(getManualApplyButton(this.config.layout.liveReload), this);
        }
    };
    Pivot.prototype._checkLayoutState = function () {
        var _this = this;
        if (this.config.layout.readonly) {
            this.layout.getCell("gridOnly").show();
            this.layout.getCell("showSettings").hide();
            return;
        }
    ...
    Pivot.prototype._render = function () {
        return dom_1.el(".dhx_widget.dhx_pivot", {
...
Object.defineProperty(exports, "__esModule", { value: true });
var ts_grid_1 = __webpack_require__(75);
var core_1 = __webpack_require__(1);
var html_1 = __webpack_require__(2);
var ts_data_1 = __webpack_require__(5);
var TreeGridCollection_1 = __webpack_require__(45);
...
var TreeGrid = /** @class */ (function (_super) {
    ...
    TreeGrid.prototype.scrollTo = function (row, col) {
        ...
        var fixedColsWidth = this.config.leftSplit
            ? ts_grid_1.getTotalWidth(this.config.columns.slice(0, this.config.leftSplit))
            : 0;
        var x = ts_grid_1.getTotalWidth(this.config.columns.slice(0, colInd)) - fixedColsWidth;
...
var keys_1 = __webpack_require__(80);
var html_1 = __webpack_require__(2);
var KeyManager = /** @class */ (function () {
...
var main_1 = __webpack_require__(9);
var Cells_1 = __webpack_require__(21);
var FixedCols_1 = __webpack_require__(110);
var FixedRows_1 = __webpack_require__(44);
var core_1 = __webpack_require__(1);
var BORDERS = 2;
...
Object.defineProperty(exports, "__esModule", { value: true });
var types_1 = __webpack_require__(3);
var InputEditor_1 = __webpack_require__(83);
var SelectEditor_1 = __webpack_require__(84);
var DateEditor_1 = __webpack_require__(85);
var CheckboxEditor_1 = __webpack_require__(100);
var ComboboxEditor_1 = __webpack_require__(101);
var lastEditor = {
    cell: {
        row: null,
        col: null,
...
var events_1 = __webpack_require__(4);
var view_1 = __webpack_require__(6);
var ts_timepicker_1 = __webpack_require__(87);
var DateHelper_1 = __webpack_require__(98);
var DateFormatter_1 = __webpack_require__(24);
var helper_1 = __webpack_require__(99);
var en_1 = __webpack_require__(38);
...
var view_1 = __webpack_require__(6);
var ts_layout_1 = __webpack_require__(23);
var ts_slider_1 = __webpack_require__(92);
var en_1 = __webpack_require__(96);
var helper_1 = __webpack_require__(97);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Cell_1 = __webpack_require__(90);
...
var events_1 = __webpack_require__(4);
var html_1 = __webpack_require__(2);
var keycodes_1 = __webpack_require__(103);
var view_1 = __webpack_require__(6);
var ts_data_1 = __webpack_require__(5);
var ts_layout_1 = __webpack_require__(23);
var ts_list_1 = __webpack_require__(104);
var ts_popup_1 = __webpack_require__(15);
...
var helper_2 = __webpack_require__(36);
...
var editors_1 = __webpack_require__(106);
exports.MOVE_UP = 1;
exports.MOVE_DOWN = 2;
...
Object.defineProperty(exports, "__esModule", { value: true });
var InputEditor_1 = __webpack_require__(107);
...
function getFixedColsHeader(renderConfig, layout) {
    var columns = renderConfig.columns.filter(function (col) { return !col.hidden; }).slice(0, renderConfig.leftSplit);
    var width = 0;
    for (var _i = 0, columns_1 = columns; _i < columns_1.length; _i++) {
        var col = columns_1[_i];
        width += col.$width;
...
function getFixedCols(renderConfig, layout) {
    ...
    if (hiddenCheck === renderConfig.leftSplit) {
        return;
    }
...
var DateFilter = /** @class */ (function (_super) {
    ...
    DateFilter.prototype._setMeta = function (oldMeta) {
        ...
        this._meta.inputFormat =
            this._meta.inputFormat || this._item.inputFormat || this._item.format || "%d.%m.%Y";
        this._createMask();
    };
    ...
    DateFilter.prototype._getCheckboxData = function () {
        ...
        if (filter.from || filter.to) {
            ...
            var to_1 = filter.to ? helpers_1.strToDate(filter.to, this._meta.inputFormat).getTime() : Math.max.apply(Math, data);
...
var DateFormatter = /** @class */ (function () {
    ...
    DateFormatter.prototype.date_part = function (date) {
        ...
        if (date.getHours() && // shift to yesterday on dst
            (date.getDate() < old.getDate() ||
                date.getMonth() < old.getMonth() ||
                date.getFullYear() < old.getFullYear())) {
    ...
    DateFormatter.prototype._add_days = function (date, inc) {
        ...
        if (inc >= 0 &&
            !date.getHours() &&
            ndate.getHours() && // shift to yesterday on dst
    ...
    DateFormatter.prototype.date_to_str = function (format, utc) {
        ...
        format = format.replace(/%[a-zA-Z]/g, function (a) {
            switch (a) {
                ...
                case "%D":
                    return '"+locale.date.dayShort[date.getDay()]+"';
                case "%l":
                    return '"+locale.date.dayFull[date.getDay()]+"';
                case "%P":
                    return '"+date.getDay()+"';
                case "%M":
                    return '"+locale.date.monthShort[date.getMonth()]+"';
                case "%F":
                    return '"+locale.date.monthFull[date.getMonth()]+"';
                case "%h":
                ...
                case "%Q":
                    return '"+locale.date.quarter[getQuarter(date)-1]+"';
                case "%q":
...
var DataPreprocessor = /** @class */ (function () {
    ...
    DataPreprocessor.prototype.normalizeFields = function (config) {
        ...
        var _loop_1 = function (key) {
            config.fields[key] = config.fields[key].map(function (el) {
                ...
                el = __assign(__assign(__assign({}, elFromList), el), { $field: key, $uid: core_1.uid() });
                if (key === "values") {
                    el.$temp = true;
                }
                else {
        ...
        config.fields.free = config.fieldList
            .filter(function (el) { return !idMap[el.id]; })
            .map(function (el) {
            el = __assign(__assign({}, el), { $field: "free", $uid: core_1.uid() });
            if (el.type === "date") {
                el.group = el.group || "dateByDay";
            }
            return el;
        });
        this._fields = config.fieldList.reduce(function (obj, f) {
            obj[f.id] = f;
            return obj;
        }, {});
    };
    ...
    DataPreprocessor.prototype.getPureFields = function (fields) {
        var f = {
            columns: __spreadArrays(fields.columns),
            rows: __spreadArrays(fields.rows),
            values: __spreadArrays(fields.values),
        };
        for (var key in f) {
    ...
    DataPreprocessor.prototype._checkData = function (data, fields) {
        var _this = this;
        var checkedData = __spreadArrays(data);
...
var Shadow = /** @class */ (function (_super) {
    ...
    function Shadow(configurator) {
        var _this = _super.call(this, document.body, null) || this;
        var shadow = dom_1.create({ render: function () { return configurator.getShadow(); } }, configurator);
        _this.mount(document.body, shadow);
        return _this;
    }
    Shadow.prototype.destructor = function () {
        this.unmount();
    };
    return Shadow;
}(view_1.View));
