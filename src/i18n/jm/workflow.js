export default {
    workflow: {
        va_file_subtitle: '* You must submit PPC Minutes file before submitting the project.',
        va_additionalFile_subtitle: '* You must submit SWG Minutes file before submitting the project.',
