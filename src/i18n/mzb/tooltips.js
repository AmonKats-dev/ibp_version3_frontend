export default {
  tooltips: {
    resources: {
      ...
      'project-details': {
        fields: {
          ...
          central: 'Identify the place where the project is going to be executed.',
          ...
          implementing_agencies: 'Agencies responsible for delivery of the project outputs.',
	...
	ii.	 Give a brief insight of the likely consequences if no government intervention is made.`,
          ...
          problem_cause: 'Please provide the likely causes of the problem both direct and indirect.',
          ...
          stakeholder: {
            ...
            responsibilities: 'Identify the persons group or organization that are involved in delivery or affected by a particular project. (i) Direct Beneficiaries (ii) Indirect Beneficiaries (iii) Project Affected Persons. ',
          },
...
(iii)	Production plan: description of the infrastructure capacity and the expected utilization rate. These elements describe the service provision from the supply side. Project scope and size should be justified in the context of the forecasted demand.`,
    ...
    With the exception of the project management, monitoring and evaluation components, the project outputs should relate to physical assets and must contribute at-least 70% of the total project.`,
          ...
          vote_id: 'Identify the implementing agency that will undertake the identified output.',
      ...
      activities: {
        fields: {
          ...
          start_date: 'For the given activity identify the financial year when it’s expected to commerce',
      ...
      project_options: {
        fields: {
          ...
          justification: 'Provide a detailed description for the selection of the option for the project intervention.',
...
(iv)	Outside this entity? What changes may be needed in policies of the Local, regional and central governments?`,
          ...
          analytical_modules: {
            ...
            financial_evaluation: {
              appraisal_methodology: 'Select the appraisal methodology to be used either CBA or CEA',
...
(vii)	What is the probability of positive economic feasibility?`,
            ...
            stakeholder_evaluations: {
              ...
              title: 'Identify the stakeholder that will be affected by the project',
