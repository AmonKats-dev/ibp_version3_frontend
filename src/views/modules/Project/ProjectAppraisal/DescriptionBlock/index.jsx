          ...
          {({ getSource, scopedFormData, formData, ...rest }) => {
            ...
            return (
              <Fragment>
                ...
                {checkFeature(
                  "project_options_show_description_score",
                  ...
                  <Fragment>
                    ...
                    <CustomInput
                      tooltipText={
                        "tooltips.resources.project_options.fields.score"
                      }
                      fullWidth
                    >
                      <TextInput
                        ...
                        // format={getFormattedScore}
                        label={translate(
                          "resources.project_options.fields.score"
                        )}
                        variant="outlined"
                        margin="none"
                      />
                    ...
                    <CustomInput
                      tooltipText={
                        "tooltips.resources.project_options.fields.cost"
                      }
                      fullWidth
                    >
                      <TextInput
                        ...
                        label={translate(
                          "resources.project_options.fields.cost"
                        )}
                        validate={[number()]}
