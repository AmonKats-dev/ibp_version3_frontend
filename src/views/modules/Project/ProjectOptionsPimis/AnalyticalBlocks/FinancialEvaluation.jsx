    ...
    <Fragment>
          ...
          <Fragment>
            ...
            >
              <TextInput
                ...
                validate={[
                  checkRequired("financial_evaluation", "fnpv"),
                  number(),
                ]}
            ...
            >
              <TextInput
                ...
                validate={[
                  ...
                  minValue(-100),
                  maxValue(100),
                  checkRequired("financial_evaluation", "irr"),
                ]}
                options={{ fullWidth: "true", disabled: props.disabled }}
              />
            </CustomInput>
      ...
      >
        <CustomTextArea
          ...
          formData={formData}
          isRequired
          validate={checkRequired("financial_evaluation", "summary")}
          label={translate(
