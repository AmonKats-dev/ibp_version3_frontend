...
const WorkflowActions = ({
  ...
  const role_id = record && record.workflow && record.workflow.role_id;
  ...
  const handleSubmitAction = () => {
    ...
    dataProvider.action("appeals", requestParams).then((resp) => {
      refresh();
    });
  };
  ...
  if (
    ...
    return (
      ...
      // )
      record.workflow.actions.map((item) => {
