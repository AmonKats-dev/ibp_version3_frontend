...
const MycEditForm = ({ projectDetails, project, ...props }) => {
  ...
  return (
    ...
    >
      ...
      <CustomInput
        ...
        fullWidth
      >
        <TextInput source="position" variant="outlined" margin="none" />
      </CustomInput>
      <CustomInput
        tooltipText={
        ...
        fullWidth
      >
        <TextInput source="contact_details" variant="outlined" margin="none" />
      </CustomInput>
      <CustomInput
        tooltipText={
