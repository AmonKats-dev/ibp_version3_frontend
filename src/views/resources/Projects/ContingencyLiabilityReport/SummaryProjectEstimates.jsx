      ...
      <div className="content-area">
        ...
        <TableContainer>
          ...
          >
            <TableHead>
              <TableRow>
                <TableCell rowSpan={2}>Thousands of Uganda Shillings</TableCell>
                <TableCell colSpan={4}>2019/2020 Approved Budget</TableCell>
                <TableCell colSpan={4}>2021/2022 Approved Estimates</TableCell>
              </TableRow>
              <TableRow>
                <TableCell>GoU</TableCell>
                <TableCell>External Fin.</TableCell>
                <TableCell>A.L.A.</TableCell>
