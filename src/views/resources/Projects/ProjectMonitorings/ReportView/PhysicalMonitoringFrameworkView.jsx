...
export const PhysicalMonitoringFrameworkView = ({
  record,
  projectDetails,
  ...props
}) => {
    ...
    <div className="landscapeSection">
      <div className="content-area">
        <h2>
          ...
          {/* {renderTitle(record, projectDetails, "Table 1: Approved Pre-Investment Logical Framework")} */}
        </h2>
        <TableContainer>
          <Table
            size="small"
          ...
          >
            <TableBody>
              <TableRow className={classes.filledRow}>
                ...
                {/* <TableCell rowspan={2}>Type of M&E activity</TableCell>
                  ...
                  item.indicators && item.indicators.length !== 0 ? (
                    [item.indicators[0]].map((indicator, idx) => (
                      <TableRow>
                        ...
                        {/* <TableCell>{record.me_type}</TableCell>
                        <TableCell>{record.data_collection_type}</TableCell>
                        <TableCell>
                        {record.frequency === "CUSTOM" ? "CUSTOM" : "YEAR"}
                        </TableCell> */}
                      </TableRow>
                    ))
                  ) : (
