...
export const ProjectPhysicalProgressStatus = ({
  record,
  projectDetails,
  ...props
}) => {
  ...
  const projectDetailsData = formatValuesToQuery(projectDetails);
  ...
  return (
    <div className="landscapeSection">
      <div className="content-area">
        <h2>
          {renderTitle(record, projectDetails, "Table 3: Project Physical Progress Status")}
        </h2>
        <TableContainer>
          <Table
            size="small"
            ...
            <TableBody>
              <TableRow className={classes.filledRow}>
                ...
                {/* <TableCell>Corrective measures and challenges</TableCell> */}
              </TableRow>
              {record.me_outputs &&
                    ...
                    <TableRow>
                      <TableCell colSpan="2">
                        <p>{`${translate("printForm.project_framework.output", {
                          ...
                          output.name || (output.output && output.output.name)
                        }`}</p>
                        ...
                        <div><b>Risk Description:</b> {output.risk_description}</div>
                        <div><b>Risk Response:</b> {output.risk_response}</div>
                        <div><b>Corrective Measures:</b> {output.challenges}</div>
                      </TableCell>
                      ...
                      {/* <TableCell>{output.challenges}</TableCell> */}
                    </TableRow>
                  );
