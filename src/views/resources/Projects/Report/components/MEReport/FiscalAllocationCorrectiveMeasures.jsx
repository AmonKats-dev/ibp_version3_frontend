...
export const FiscalAllocationCorrectiveMeasures = (props) => {
  ...
  return (
    <div className="landscapeSection">
      <div className="content-area">
        <h2>Table 8: Fiscal Allocation Corrective Measures</h2>
        <TableContainer>
          <Table
            size="small"
                  ...
                  const activities = getActivitiesForOutput(
                    ...
                    return (
                      <TableRow>
                        ...
                        <TableCell>
                          {HTML2React(activity.allocation_challenges)}
                        </TableCell>
                        <TableCell>
                          {HTML2React(activity.allocation_measures)}
                        </TableCell>
                      </TableRow>
                    );
                  });
