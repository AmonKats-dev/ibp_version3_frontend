          ...
          <Table
            ...
            <TableBody>
              ...
              <TableRow className={classes.filledRow}>
                ...
                <TableCell>Releases Spent</TableCell>
                <TableCell>Status</TableCell>
              </TableRow>
              {meReport.me_outputs &&
                meReport.me_outputs.map((output, outputIdx) => {
                  ...
                  const activities = getActivitiesForOutput(
                    ...
                    return (
                      <TableRow>
                        ...
                        <TableCell>{activity.financial_execution}</TableCell>
                        <TableCell>
                          {getStatus(
                            1 -
                  ...
                  outputsData.push(
                    <TableRow className={classes.filledRow}>
                      ...
                      <TableCell>
                        {getStatus(
                          1 - output.release_budget / output.release_budget
                        )}
                      </TableCell>
                      <TableCell>{output.release_spent}</TableCell>
                      <TableCell>
                        {getStatus(
