                      ...
                      >
                        <TableBody>
                          ...
                          <TableRow>
                            ...
                            <TableCell>{item.funding_modality}</TableCell>
                          </TableRow>
                          {item.funding_modality !== "PROCUREMENT" ? (
                            <>
                              <TableRow>
                                ...
                                <TableCell>{item.value_for_money}</TableCell>
                              </TableRow>
                              <TableRow>
                                <TableCell>
                                  {translate(
                                ...
                                <TableCell>{item.risk_allocation}</TableCell>
                              </TableRow>
                              <TableRow>
                                <TableCell>
                                  {translate(
                              ...
                              <TableRow>
                                ...
                                <TableCell>{item.me_strategy}</TableCell>
                              </TableRow>
                            </>
                          ) : null}
