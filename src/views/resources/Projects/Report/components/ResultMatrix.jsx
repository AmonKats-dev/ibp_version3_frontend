          ...
          >
            <TableBody>
              <TableRow className={classes.filledRow}>
                ...
                <TableCell rowspan="2" style={{ width: 200 }}>
                  {translate("printForm.result_matrix.assumption")}
                </TableCell>
                <TableCell rowspan="2" style={{ width: 200 }}>
                  {translate("printForm.result_matrix.risks")}
                </TableCell>
              </TableRow>
              <TableRow>
              ...
              {record && record.indicators && record.indicators.length !== 0 ? (
                record.indicators.map((indicator, idx) => (
                  <TableRow>
                    ...
                    <TableCell style={{ width: 350 }}>{`Indicator ${idx + 1}: ${
                      indicator.name
                    }`}</TableCell>
            ...
            <TableContainer>
              ...
              >
                <TableBody>
                  <TableRow className={classes.filledRow}>
                    <TableCell>
                      {translate("printForm.result_matrix.activities_title")}
                    </TableCell>
                  </TableRow>
                  {record &&
                    record.outputs &&
                    record.outputs.map((output, outputIdx) => [
                      ...
                      getActivitiesForOutput(record, output.id) && (
                        <TableRow>
                          <TableCell>
                            <ul>
                              {getActivitiesForOutput(record, output.id).map(
                                (activity, idxAct) => (
                                  <li>
                                    <p>
                                      {`${outputIdx + 1}.${idxAct + 1}`}{" "}
                                      {activity.name}
                                    </p>
                                    <p
                                      style={{
                                    ...
                                    >
                                      {HTML2React(activity.description)}
                                    </p>
                                  </li>
                                )
                              )}
