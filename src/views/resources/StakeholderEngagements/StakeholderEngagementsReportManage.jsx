...
const StakeholderEngagementsReportManage = (props) => {
                    ...
                    <TableRow>
                      ...
                      <TableCell>
                        ...
                        <DeleteButton
                          ...
                          resource={props.resource}
                          redirect={() => {
                            return `/stakeholder-engagements/${record?.project_detail_id}/list`;
                          }}
                        />
                      </TableCell>
                    </TableRow>
...
export default StakeholderEngagementsReportManage;
